...
<html>
  ...
  <body>
	...
	<li class="active"><?php echo $this->scope["nombre"];?></li>
</ul>
<?php if (! (isset($this->scope["bloqueado"]) ? $this->scope["bloqueado"] : null)) {
?>

<div class="box_btnnuevo">
	<a href="/admin/<?php echo $this->scope["modelo"];?>/-1" class="btn btn-success">Nuevo</a>
</div>
<?php 
}?>
